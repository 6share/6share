...
/*
 * This function compress input to output then closes both files.
 *
 * Params:	FILE *in: Input file,
 *			gzFile out: Output file.
 *
...
/*
 * This function uncompress input to output then closes both files.
 *
 * Params:	FILE *in: Input file,
 *			gzFile out: Output file.
 *
...
/*
 * This function compress the given file and creates a corresponding .gz file.
 *
 * Params:	char* file: Pointer to buffer containing file name,
 *			char* mode: Pointer to buffer containing compression mode.
 *
 * Return: int: 0 in success, -1 otherwise
 *
 */
...
/*
 * This function compress the given buffer.
 *
 * Params:	char *buf: Pointer to buffer to be compressed,
 *			ULONGLONG/unsigned long long buflen: Buffer length,
 *			ULONGLONG/unsigned long long *comprlen: Compressed buffer length.  
 *
 * Return:	char*: Pointer to buffer containing compressed data, 
 *			NULL: In error cases.
 *
 */
...
/*
 * This function uncompress the given buffer.
 *
 * Params:	char *buf: Pointer to buffer to be uncompressed,
 *			ULONGLONG/unsigned long long buflen: Buffer length,
 *			ULONGLONG/unsigned long long *uncomprlen: Uncompressed buffer length.  
 *
 * Return:	char*: Pointer to buffer containing uncompressed data, 
 *			NULL: In error cases.
 *
 */
